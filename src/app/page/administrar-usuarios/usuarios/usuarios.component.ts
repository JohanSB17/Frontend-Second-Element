...
export class UsuariosComponent implements OnInit, OnDestroy {
  ...
  recibirInformacion(data: UsuarioModel) {
    ...
    Swal.fire({
      title: 'Información',
      html: `<ul>
              <lilist-style="none"> <b>Nombre: </b>${this.informacion.nombre}</lilist-style=><br>

              <lilist-style="none"> <b>Email: </b>${this.informacion.email}</lilist-style=><br>

              <lilist-style="none"> <b>Tipo de Documento: </b>${this.informacion.tipoDocumento}</lilist-style=><br>

              <lilist-style="none"> <b>Numero de Documento: </b>${this.informacion.numeroDocumento}</lilist-style=><br>
            </ul>`,
      icon: 'success',
    });
  }
